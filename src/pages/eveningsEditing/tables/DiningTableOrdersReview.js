...
export default class DiningTableOrdersReview extends React.Component {
    constructor(props) {
        super(props);
    }
    ...
    render() {
        ...
        let ordersComponents = groups.map(grp => {
            ...
            return <Row key={grp.get('groupId')}>
                <Column>
                    <FormattedParagraph textColor={textColor} leftText={left} rightText={OrdinationsUtils.formatGroupPrice(grp)}/>
                </Column>
            </Row>;
        });
