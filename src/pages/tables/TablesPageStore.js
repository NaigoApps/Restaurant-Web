...
class TablesPageStore extends RootFeatureStore {
    ...
    getCompletionHandlers() {
        ...
        handlers[TablesPageActions.CREATE_R_TABLE] = (table) =>
            this.initEditor(new RestaurantTable(table.toJS(), dataStore.getPool()), false);
    ...
    getState() {
        return {
            data: {
                tables: dataStore.getEntities(Topics.RESTAURANT_TABLES),
                editor: this.editor,
